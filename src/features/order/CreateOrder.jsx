    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-12 flex items-center gap-5">
          <input
            className="h-6 w-6 border-none accent-red-400 outline-none focus:outline-none focus:ring focus:ring-red-400 focus:ring-offset-2"
            type="checkbox"
            name="priority"
            id="priority"
            value={withPriority}
          ...
          <label className="font-medium" htmlFor="priority">
            ...
            <p className="font-small"> extra 20% is charged</p>
          </label>
        </div>
