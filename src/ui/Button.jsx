...
function Button({ children, disabled, to, type, onClick }) {
  const base =
    "text-sm focus-bg-red-300 inline-block rounded-full bg-red-400  font-semibold uppercase tracking-wide transition-colors duration-300 hover:bg-red-300 focus:outline-none focus:ring focus:ring-red-300 focus:ring-offset-2 disabled:cursor-not-allowed ";
